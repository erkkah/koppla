...
class CompiledSchematic {
    ...
    resolve(symbols) {
        ...
        for (const connection of this.connections) {
            ...
            const targetTerminal = (_c = connection.targetTerminal) !== null && _c !== void 0 ? _c : targetSymbol.terminals[0];
...
function compileDefinition(schematic, definition, typeFromSymbol) {
    ...
    const designator = (_b = (_a = definition.designator) === null || _a === void 0 ? void 0 : _a.designator) !== null && _b !== void 0 ? _b : typeFromSymbol;
