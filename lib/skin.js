...
class SymbolSkin {
    ...
    updateDynamicSize(size) {
        var _a, _b;
        (0, assert_1.default)((_a = this.options) === null || _a === void 0 ? void 0 : _a.dynamic);
        this.size.x = size.x;
        this.size.y = size.y;
        (0, assert_1.default)(((_b = this.svg.rect) === null || _b === void 0 ? void 0 : _b.length) === 1);
...
class Skin {
    ...
    dynamicSymbol(symbolInfo) {
        const boxSize = Object.assign({}, Skin.minimumBoxSize);
        const box = {
            "@attrs": {},
            rect: [
                {
